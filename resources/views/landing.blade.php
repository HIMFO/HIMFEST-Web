  ...
  <header>
    <nav id="header" class="fixed w-full z-30 top-0 text-white">
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-4 py-2">
        <a class="toggleColour flex items-center text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            ...
            <li class="mr-3">
              <a class="inline-block text-white no-underline hover:text-gray-800 hover:text-underline py-2 px-4 toggleColour" href="#prizes">Prizes</a>
            </li>                  
            <li class="mr-3">
              <a class="inline-block text-white no-underline hover:text-gray-800 hover:text-underline py-2 px-4 toggleColour" href="{{ route('login') }}">Login</a>
            </li>
          </ul>
  ...
  <main>
    ...
    <section id="guidelines" class="bg-gray-100 border-b py-8">
      <div class="container mx-auto flex flex-wrap pt-4 pb-12">
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink justify-center">
        ...
        <div class="flex-1">
          ...
          <ul class="list-reset mb-6">
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a href="mailto:it.himfo@gmail.com" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Email</a>
            </li>
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a href="https://line.me/R/ti/p/jonathanevans" target="_blank" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Line</a>
            </li>
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a href="https://wa.me/6285855872872" target="_blank" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Whatsapp</a>
            </li>
          </ul>
        </div>
        <div class="flex-1">
          ...
          <ul class="list-reset mb-6">
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a href="https://www.instagram.com/himfo.binusmlg/" target="_blank" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Instagram</a>
            </li>
          </ul>
        </div>
    </div>
